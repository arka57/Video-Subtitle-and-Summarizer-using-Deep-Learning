...
from src1.components.video_to_subtitle import SubtitleGenerator,Video2SubConfig
from src1.components.summarize import Summarizer
from src1.pipeline import run_training_pipeline
import threading
from gtts import gTTS
from src1.components.video_downloader import VideoDownloader

app=Flask(__name__)
app.config['upload_dir']=os.path.join('uploads/')
os.makedirs(app.config['upload_dir'],exist_ok=True)

print("Load summarizer Model")
...
def upload_file():
    """
    The function upload_file() takes in a video file or a video link,transcribes the video,
    and summarizes the transcript
    ...
    if request.method =='POST':
        ...
        if video_file:
            ...
            subtitle=subtitle_generator.get_subtitles(video_paths=video_path,model_path=tiny,
