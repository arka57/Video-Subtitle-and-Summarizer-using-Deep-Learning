...
from src1.components.data_validation import DataValidation
from src1.components.data_preprocessing import DataProcessing,DataProcessingConfig
...
def create_directories(config=TrainingPipelineConfig):
    ...
    #Check if artifacts folder exists or not
...
def run_training_pipeline(config=TrainingPipelineConfig):
    ...
    data_processing_config=DataProcessingConfig(max_input_length=128,max_target_length=64,
                                                dataset_folder=config.data_ingestion_artifacts,
                                                artifacts_folder=config.data_processing_artifacts)
