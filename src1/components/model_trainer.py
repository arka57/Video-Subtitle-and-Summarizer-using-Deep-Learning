...
class ModelTrainer:
    ...
    def initialize_model_tokenizer(self):
        try:
            logger.info("Initialize model and tokenizer for training...")
            ...
            logger.error(f"Exception occured while initialising model and tokenizer: {e}")
    ...
    def load_tokenized_datasets(self):
        try:
            ...
            logger.error(f"Exception occured while loading tokenized datasets: {e}")
            raise CustomException(e,sys)
    ...
    def setup_trainer(self):
        try:
            logger.info("setting model trainer class")
            batch_size=64
            ...
            args=Seq2SeqTrainingArguments(
                ...
                fp16=False,#true if gpu present,
                push_to_hub=False
            )
            ...
            logger.error(f"Exception occured while setting up trainer: {e}")
            raise CustomException(e,sys)
    ...
    def train_model(self):
        try:
            ...
            logger.error(f"Exception occred during model training: {e}")
            raise CustomException(e,sys)
    ...
    def train(self):
        try:
            ...
            logger.error(f"Exception occured during model training: {e}")
            raise CustomException(e,sys)