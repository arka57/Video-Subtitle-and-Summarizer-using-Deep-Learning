...
class DataProcessing:
    ...
    def preprocess_function(self,examples):
        try:
            ...
            model_inputs=self.tokenizer(inputs,max_length=self.config.max_input_length,
                                        truncation=True)
            labels=self.tokenizer(examples["summary"],max_length=self.config.max_target_length,
                                  truncation=True)
